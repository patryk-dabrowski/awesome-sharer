...
ALLOWED_HOSTS = ['awesome-sharer.herokuapp.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('SQL_DATABASE', 'awesomesharer'),
        'USER': os.environ.get('SQL_USER', 'awesomesharer'),
        'HOST': os.environ.get('SQL_HOST', 'db'),
        'PASSWORD': os.environ.get('SQL_PASSWORD', 'awesomesharer'),
